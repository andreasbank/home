  ...
  public function find_user_full_name($username, $password = null) {
      ...
      if($ldapconn) {
        ...
        if ($ldapbind) {
          ...
          // TODO: check if it was a successfull connect and give a different error message
...
elseif(!isset($_COOKIE['axis-home']) || empty($_COOKIE['axis-home'])) {
  printf($html_header);
?>
